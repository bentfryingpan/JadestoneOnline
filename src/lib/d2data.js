...
export const SECONDARY_ZONE = {
	...
	1735777505: {
		...
		bonuses: [
			{
				label: 'Grenade DMG (PvE)',
				key: 'grenadeDmgPvE',
				max: 65,
				unit: '%',
				desc: 'Scales all grenade damage in PvE activities. Does NOT apply to keyword-only grenades (e.g. Grapple Melee portion, Healing Grenade restoration).'
			},
			{
				label: 'Grenade DMG (PvP)',
				key: 'grenadeDmgPvP',
				max: 20,
				unit: '%',
				desc: 'Crucible & Trials — stacks with standard grenade damage. Notable power investment for aggressive builds.'
			}
		],
		...
		bonuses: [
			{
				...
				max: 30,
				unit: '%',
				desc: 'Applies to powered melees, uncharged melees, and Glaive melee attacks.'
			},
			{
				label: 'Melee DMG (PvP)',
				key: 'meleeDmgPvP',
				max: 20,
				unit: '%',
				desc: 'Stacks with other melee buffs. Significant for Titan Shoulder Charge / Hunter backstab builds.'
			}
		],
		...
		bonuses: [
			{
				...
				max: 45,
				unit: '%',
				desc: 'Boosts total Super damage output. Great for boss DPS supers (e.g. Well of Radiance, Blade Barrage, Chaos Reach).'
			},
			{
				label: 'Super DMG (PvP)',
				key: 'superDmgPvP',
				max: 15,
				unit: '%',
				desc: 'Can push one-shot thresholds in Crucible.'
			}
		],
	...
	392767087: {
		...
		bonuses: [
			{
				label: 'Shield Capacity (PvE)',
				key: 'shieldCap',
				max: 20,
				unit: ' HP',
				desc: 'Additional shield HP on top of your base 70 HP shield. At 200 you have a 90 HP shield.'
			},
			{
				label: 'Shield Regen Start',
				key: 'regenStart',
				max: 25,
				unit: '%',
				desc: 'Your shields begin recharging this much faster after damage stops.'
			},
			{
				label: 'Full Regen Speed',
				key: 'regenFull',
				max: 50,
				unit: '%',
				desc: 'Shields recharge to full in this much less time once regen begins. At 200, full regen is twice as fast.'
			}
		],
		...
		highlight: 160,
		highlightNote:
			'At stat 160: +12HP shield, +15% regen start, +30% faster full regen — matches old max Recovery regen speed.'
	},
	...
	1943323491: {
		...
		bonuses: [
			{
				label: 'Overshield (PvE)',
				key: 'overshieldPvE',
				max: 40,
				unit: ' HP',
				desc: 'Grants an overshield on top of normal HP when you use your class ability. Lasts 5s for quick abilities (Dodge), 10s for slower ones (Barricade, Rift).'
			},
			{
				label: 'Overshield (PvP)',
				key: 'overshieldPvP',
				max: 20,
				unit: ' HP',
				desc: 'Provides a temporary HP buffer in Crucible — powerful for Titans with extended Barricade.'
			}
		],
	...
	2996146975: {
		...
		bonuses: [
			{
				label: 'Boss DMG — Primary/Special',
				key: 'bossDmgPS',
				max: 15,
				unit: '%',
				desc: 'Increases damage to boss-tier enemies from Kinetic, Energy, and Special weapons.'
			},
			{
				label: 'Boss DMG — Heavy',
				key: 'bossDmgH',
				max: 10,
				unit: '%',
				desc: 'Increases damage to boss-tier enemies from Power/Heavy slot weapons.'
			},
			{
				label: 'Guardian DMG (PvP)',
				key: 'pvpDmg',
				max: 6,
				unit: '%',
				desc: 'Bonus weapon damage vs. other Guardians in Crucible/Trials.'
			},
			{
				label: 'Double Ammo Bricks',
				key: 'doubleBricks',
				max: 100,
				unit: '%',
				desc: 'Chance for ammo pickups to contain double ammo. At 200, guaranteed double ammo from every brick.'
			}
		],
