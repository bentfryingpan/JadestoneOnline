...
export async function load({ url }) {
    ...
    const { data: rows } = await supabaseAdmin
        ...
        .select('player_id, bungie_name, bungie_code, activities_entered, activities_won, kd_ratio, win_rate, invasions, invasion_kills, motes_deposited, motes_lost, updated_at')
