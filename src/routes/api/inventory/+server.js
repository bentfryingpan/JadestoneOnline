...
import { getItemDef, getSandboxPerkDef, getStatDef, getDamageTypeDef } from '$lib/server/manifest.js';
    ...
    try {
        ...
        for (const item of allItems) {
            ...
            for (const s of sock) {
                ...
                if (plugDef?.itemCategoryHashes?.includes(2237026323)) { // Trait Category
                    perks.push({
                        hash: s.plugHash,
